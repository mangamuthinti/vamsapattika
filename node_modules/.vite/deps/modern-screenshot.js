...
function changePngDpi(uint8Array, dpi, overwritepHYs = false) {
	const physChunk = /* @__PURE__ */ new Uint8Array(13);
	dpi *= 39.3701;
	physChunk[0] = _P;
	physChunk[1] = _H;
	physChunk[2] = _Y;
	...
	const crcChunk = /* @__PURE__ */ new Uint8Array(4);
	crcChunk[0] = crc >>> 24;
	crcChunk[1] = crc >>> 16;
	crcChunk[2] = crc >>> 8;
	crcChunk[3] = crc & 255;
	if (overwritepHYs) {
		...
		const chunkLength = /* @__PURE__ */ new Uint8Array(4);
		chunkLength[0] = 0;
		chunkLength[1] = 0;
		chunkLength[2] = 0;
		chunkLength[3] = 9;
		const finalHeader = /* @__PURE__ */ new Uint8Array(54);
