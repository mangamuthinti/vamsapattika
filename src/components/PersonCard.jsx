...
const PersonCard = ({ personId }) => {
  ...
  React.useEffect(() => {
    console.log(`PersonCard ${personId} rendered with:`, {
      shape: person.shape,
      customColors: person.customColors,
      appliedBackground: person.customColors?.background || 'default gradient'
    });
  }, [person.shape, person.customColors]);
